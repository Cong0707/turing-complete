...
def _xor_gate(project_root: Path, level: str) -> tuple[tuple[Component, ...], tuple[Wire, ...]]:
    ...
    components = scaffold + (
        Component(4, (-1, -6), 0, stable_permanent_id(level, "and")),
        Component(9, (-1, 4), 0, stable_permanent_id(level, "nor-inputs")),
        Component(9, (6, -1), 0, stable_permanent_id(level, "nor-output")),
    )
    wires = (
        wire_from_vertices(((-8, -3), (-3, -8), (-2, -7))),
        wire_from_vertices(((-8, -3), (-7, -4), (-1, 2), (-2, 3))),
        wire_from_vertices(((-8, -1), (-7, 0), (-2, -5))),
        wire_from_vertices(((-8, -1), (-2, 5))),
        wire_from_vertices(((1, -6), (5, -2))),
        wire_from_vertices(((1, 4), (5, 0))),
        wire_from_vertices(((8, -1), (11, -1), (12, 0))),
    )
    return components, wires
...
def _xnor(project_root: Path, level: str) -> tuple[tuple[Component, ...], tuple[Wire, ...]]:
    scaffold = _load_scaffold_components(project_root, level)
    components = scaffold + (
        Component(4, (-5, -5), 0, stable_permanent_id(level, "and")),
        Component(9, (-5, 5), 0, stable_permanent_id(level, "nor")),
        Component(7, (4, 0), 0, stable_permanent_id(level, "or")),
    )
    wires = (
        wire_from_vertices(((-13, -1), (-7, -7), (-6, -6))),
        wire_from_vertices(((-13, -1), (-12, -2), (-6, 4))),
        wire_from_vertices(((-13, 1), (-12, 2), (-6, -4))),
        wire_from_vertices(((-13, 1), (-7, 7), (-6, 6))),
        wire_from_vertices(((-3, -5), (2, 0), (3, -1))),
        wire_from_vertices(((-3, 5), (2, 0), (3, 1))),
...
def _counting_signals(project_root: Path, level: str) -> tuple[tuple[Component, ...], tuple[Wire, ...]]:
    scaffold = _load_scaffold_components(project_root, level)
    components = scaffold + (
        Component(4, (-9, -13), 0, stable_permanent_id(level, "ab-and")),
        Component(9, (-9, -7), 0, stable_permanent_id(level, "ab-nor")),
        Component(9, (-2, -10), 0, stable_permanent_id(level, "ab-sum")),
        Component(4, (-9, 7), 0, stable_permanent_id(level, "cd-and")),
        Component(9, (-9, 13), 0, stable_permanent_id(level, "cd-nor")),
        Component(9, (-2, 10), 0, stable_permanent_id(level, "cd-sum")),
        Component(4, (5, -9), 0, stable_permanent_id(level, "pq-and")),
        Component(9, (5, -3), 0, stable_permanent_id(level, "pq-nor")),
        Component(9, (10, -6), 0, stable_permanent_id(level, "bit-0")),
        Component(4, (5, 3), 0, stable_permanent_id(level, "gh-and")),
        Component(9, (5, 9), 0, stable_permanent_id(level, "gh-nor")),
        Component(9, (10, 6), 0, stable_permanent_id(level, "gh-sum")),
        Component(7, (10, 0), 0, stable_permanent_id(level, "bit-1")),
    )
    wires = (
        wire_from_vertices(((-14, -2), (-14, -10), (-10, -14))),
        wire_from_vertices(((-14, -2), (-14, -4), (-10, -8))),
        wire_from_vertices(((-14, -1), (-11, -4), (-11, -11), (-10, -12))),
        wire_from_vertices(((-14, -1), (-11, -4), (-11, -5), (-10, -6))),
        wire_from_vertices(((-14, 0), (-10, 4), (-11, 5), (-10, 6))),
        wire_from_vertices(((-14, 0), (-11, 3), (-11, 11), (-10, 12))),
        wire_from_vertices(((-14, 1), (-14, 4), (-10, 8))),
        wire_from_vertices(((-14, 1), (-14, 10), (-10, 14))),
        wire_from_vertices(((-7, -13), (-4, -10), (-3, -11))),
        wire_from_vertices(((-7, -7), (-4, -10), (-3, -9))),
        wire_from_vertices(((-7, 7), (-4, 10), (-3, 9))),
        wire_from_vertices(((-7, 13), (-4, 10), (-3, 11))),
        wire_from_vertices(((0, -10), (4, -10))),
        wire_from_vertices(((0, -10), (5, -5), (4, -4))),
        wire_from_vertices(((0, 10), (0, -4), (4, -8))),
        wire_from_vertices(((0, 10), (0, 2), (4, -2))),
        wire_from_vertices(((7, -9), (9, -7))),
        wire_from_vertices(((7, -3), (9, -5))),
        wire_from_vertices(((-7, -13), (-4, -10), (-4, -6), (4, 2))),
        wire_from_vertices(((-7, -13), (-4, -10), (-4, 0), (4, 8))),
        wire_from_vertices(((-7, 7), (1, 7), (4, 4))),
        wire_from_vertices(((-7, 7), (1, 7), (4, 10))),
        wire_from_vertices(((7, 3), (9, 5))),
        wire_from_vertices(((7, 9), (9, 7))),
        wire_from_vertices(((7, -9), (8, -8), (8, -2), (9, -1))),
        wire_from_vertices(((12, 6), (12, 4), (9, 1))),
        wire_from_vertices(((12, -6), (12, -3), (14, -1))),
        wire_from_vertices(((12, 0), (14, 0))),
        wire_from_vertices(((7, 3), (12, 3), (14, 1))),
    )
    return components, wires
...
def _decoder_3(project_root: Path, level: str) -> tuple[tuple[Component, ...], tuple[Wire, ...]]:
    ...
    wires = (
        ...
        wire_from_vertices(((-11, 1), (-2, -8), (0, -6))),
