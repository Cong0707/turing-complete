        ...
        __int64 *a10)
{
  ...
  __int64 (__fastcall *v192)(int, int, int, int, int, __int64); // [rsp+570h] [rbp+4F0h] BYREF
  _QWORD *v193; // [rsp+578h] [rbp+4F8h]
  __int64 v194; // [rsp+580h] [rbp+500h] BYREF
  _QWORD *v195; // [rsp+588h] [rbp+508h]
  __int64 (__fastcall *v196)(__int64 *, __int64); // [rsp+590h] [rbp+510h] BYREF
  ...
  __int64 (__fastcall *v377)(int, int, int, int, int, __int64); // [rsp+B80h] [rbp+B00h] BYREF
...
LABEL_953:
      ...
      if ( LOBYTE(v128[0]) >= 0x54u )
      {
        ...
        if ( v1006 )
        {
          v377((int)&v381, (int)v128, 0, v128[28], 0, (__int64)v378);
        }
        else
        {
...
LABEL_1396:
  ...
  while ( v1014 < v763 )
  {
    ...
    if ( v1012 )
    {
      ...
      if ( v193 )
      {
        v192((int)&v230, (int)&v115[560 * v1013 + 8], 1, 32, 0, (__int64)v193);
      }
      else
      {
