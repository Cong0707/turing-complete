"""Audit the OR-to-AND one-kind neighbor of the tail ordinary multiset."""
...
ORDINARY_MULTISET = ("NOT", "NOR", "OR", "AND")
TERMINAL = {"sat", "unsat"}
ZERO_FIELDS = (
    "mismatch_count",
    "bus_conflict_count",
...
def audit(spec_path: Path) -> dict[str, object]:
    ...
    if sat_paths and manifest_complete and worker_match and not invalid:
        ...
        status = "incomplete"
    return {
        "schema": "s567c8-g18-o4-s7-adjacent-or-to-and-audit-v1",
        "status": status,
