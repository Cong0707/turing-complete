"""Generate the OR-to-NOT neighbor of the tail ordinary multiset.

This family replaces one of the two OR kinds in NOT,NOR,OR,OR with NOT,
enumerates the 12 unique orders of NOT,NOR,OR,NOT, and fixes seven terminal
...
ADJACENT_MULTISET = ("NOT", "NOR", "OR", "NOT")
PRIORITY_ORDERS = (
    ("NOT", "NOR", "NOT", "OR"),
    ("NOT", "NOR", "OR", "NOT"),
)
...
def build(args: argparse.Namespace) -> dict[str, object]:
    ...
    for ordinary in unique_orders():
        ...
        name = f"s567c8-d5-g18-o04-s07-adj-or2not-{suffix}"
    ...
    return {
        ...
        "description": (
            ...
            "NOT,NOR,OR,NOT followed by seven terminal Switch components"
        ),
        "proof_scope": {
            "domain": "s34567c8_leaf",
            "outputs": ["S5", "S6", "S7", "C8"],
            ...
            "unique_orders": 12,
            "coverage": (
                "complete-for-or-to-not-neighbor-terminal-switch-class"
            ),
...
def main() -> int:
    ...
    parser.add_argument(
        "--name",
        default="local_s567c8_g18_o4_s7_adj_or2not_w3",
    )
