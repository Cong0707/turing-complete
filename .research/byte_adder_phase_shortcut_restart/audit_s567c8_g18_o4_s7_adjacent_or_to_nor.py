"""Audit the OR-to-NOR one-kind neighbor of the tail ordinary multiset."""
...
ORDINARY_MULTISET = ("NOT", "NOR", "OR", "NOR")
TERMINAL = {"sat", "unsat"}
ZERO_FIELDS = (
    "mismatch_count",
    "bus_conflict_count",
...
def audit(spec_path: Path) -> dict[str, object]:
    ...
    for value in spec.get("values", ()):
        ...
        expected_name = f"s567c8-d5-g18-o04-s07-adj-or2nor-{suffix}"
    ...
    proof_matches = (
        ...
        and proof.get("one_kind_change") == "OR->NOR"
    ...
    if sat_paths and manifest_complete and worker_match and not invalid:
        ...
        status = "incomplete"
    return {
        "schema": "s567c8-g18-o4-s7-adjacent-or-to-nor-audit-v1",
        "status": status,
