"""Generate the first one-kind neighbor of the tail ordinary multiset.

This family replaces one of the two OR kinds in NOT,NOR,OR,OR with AND,
enumerates the 24 unique orders of NOT,NOR,OR,AND, and fixes seven terminal
...
ADJACENT_MULTISET = ("NOT", "NOR", "OR", "AND")
PRIORITY_ORDERS = (
    ("NOT", "NOR", "AND", "OR"),
    ("NOT", "NOR", "OR", "AND"),
)
...
def build(args: argparse.Namespace) -> dict[str, object]:
    ...
    for ordinary in unique_orders():
        ...
        name = f"s567c8-d5-g18-o04-s07-adj-or2and-{suffix}"
    ...
    return {
        ...
        "name": args.name,
        "description": (
            "All 24 unique orders of the one-kind neighbor NOT,NOR,OR,AND "
        ...
        "proof_scope": {
            ...
            "unique_orders": 24,
            "coverage": "complete-for-or-to-and-neighbor-terminal-switch-class",
...
def main() -> int:
    ...
    parser.add_argument(
        "--name",
        default="local_s567c8_g18_o4_s7_adj_or2and_w4",
    )
