...
WORK="$ROOT/.research/byte_adder_global_d5_switch_restore_all268_c21415fe"
RUN_DIR="$WORK/remote-all268-enumerate-as6g"
...
cp "$WORK/remote_all268_enumerate_as6g_run.sh" "$RUN_DIR/run.sh"
cp "$WORK/remote_all268_enumerate_as6g_spec.json" "$RUN_DIR/spec.json"
{
