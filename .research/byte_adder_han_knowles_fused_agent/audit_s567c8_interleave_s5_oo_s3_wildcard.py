"""Audit complete wildcard coverage for SWITCHx5,K1,K2,SWITCHx3."""
...
BASENAME = "s567c8_g18_o2s8_interleave_s5_oo_s3_cadical195"
EVIDENCE = REMOTE / f"{BASENAME}.json"
LOG = REMOTE / f"{BASENAME}.log"
RUN = REMOTE / f"{BASENAME}.run.json"
DEFAULT_MANIFEST = HERE / "s567c8_interleave_s5_oo_s3_wildcard_manifest.json"
DEFAULT_AUDIT = HERE / "s567c8_interleave_s5_oo_s3_wildcard_audit.json"
...
EXPECTED = {
    "evidence": "a4cfe04b54b576a0becb0bc1c2643e7877533567476a7cf37a44293df1876e95",
    "log": "e5194c0242a3c7a919bfd4ba91fb155795182d911f8d9a9bac352f479a91c153",
    "run": "9682c1b0fc7ce5372f0c54c6da880bc05c23adc111d02b452a0178bac2c4bd86",
...
def main() -> int:
    ...
    if missing:
        audit = {
            "schema": "s567c8-interleave-s5-oo-s3-wildcard-audit-v1",
            "status": "incomplete",
            "missing": missing,
            "invalid": invalid,
        }
    ...
    manifest = {
        "schema": "s567c8-interleave-s5-oo-s3-wildcard-manifest-v1",
        ...
        "coverage_proof": {
            ...
            "exact_switches": 8,
            "fixed_switch_slots": [0, 1, 2, 3, 4, 7, 8, 9],
        ...
        "scope_exclusions": [
            "ordinary slots other than 5 and 6",
        ...
        "conclusion": (
            ...
            "pairs for topology SWITCHx5,K1,K2,SWITCHx3. The width-1 shard "
