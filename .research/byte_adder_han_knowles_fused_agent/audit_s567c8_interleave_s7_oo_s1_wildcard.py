"""Audit complete wildcard coverage for SWITCHx7,K1,K2,SWITCH."""
...
BASENAME = "s567c8_g18_o2s8_interleave_s7_oo_s1_cadical195"
EVIDENCE = REMOTE / f"{BASENAME}.json"
LOG = REMOTE / f"{BASENAME}.log"
RUN = REMOTE / f"{BASENAME}.run.json"
DEFAULT_MANIFEST = HERE / "s567c8_interleave_s7_oo_s1_wildcard_manifest.json"
DEFAULT_AUDIT = HERE / "s567c8_interleave_s7_oo_s1_wildcard_audit.json"
...
EXPECTED = {
    "evidence": "5b979b6b5f4a3b0f32f02b6fc9bbe2c196c2265f0b8315fd2fdca82a74010c6c",
    "log": "344f5913b37eca5bef7cc0b75a485994141e3bf9224d53a3f5dab18eead1dbaa",
    "run": "182685a484d80013fe09cafb5e258087c7453e5a80cf2b1c7866949d65f267f9",
...
def main() -> int:
    ...
    if missing:
        audit = {
            "schema": "s567c8-interleave-s7-oo-s1-wildcard-audit-v1",
            "status": "incomplete",
            "missing": missing,
            "invalid": invalid,
        }
    ...
    manifest = {
        "schema": "s567c8-interleave-s7-oo-s1-wildcard-manifest-v1",
        ...
        "coverage_proof": {
            ...
            "exact_switches": 8,
            "fixed_switch_slots": [0, 1, 2, 3, 4, 5, 6, 9],
        ...
        "scope_exclusions": [
            "ordinary slots other than 7 and 8",
        ...
        "conclusion": (
            ...
            "pairs for topology SWITCHx7,K1,K2,SWITCH. The width-1 shard "
