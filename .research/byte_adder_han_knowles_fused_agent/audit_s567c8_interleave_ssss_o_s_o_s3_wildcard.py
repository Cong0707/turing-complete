"""Audit complete wildcard coverage for SWITCHx4,K1,SWITCH,K2,SWITCHx3."""
...
BASENAME = "s567c8_g18_o2s8_interleave_ssss_o_s_o_s3_cadical195"
EVIDENCE = REMOTE / f"{BASENAME}.json"
LOG = REMOTE / f"{BASENAME}.log"
RUN = REMOTE / f"{BASENAME}.run.json"
DEFAULT_MANIFEST = HERE / "s567c8_interleave_ssss_o_s_o_s3_wildcard_manifest.json"
DEFAULT_AUDIT = HERE / "s567c8_interleave_ssss_o_s_o_s3_wildcard_audit.json"
...
EXPECTED = {
    "evidence": "61b9a27f390f6dfc504e79abe92c7698a98cc95757a25e66298f8f08a2be8482",
    "log": "1c256c81f5b0567a0f08ebc3e786497b3103809550f8e51d03422c2c57d7f54f",
    "run": "4fb0fe2d829ee6e1650521b428c74f69ab393fa3d049162c1aedbddbc0e644f6",
...
def main() -> int:
    ...
    if missing:
        audit = {
            "schema": "s567c8-interleave-ssss-o-s-o-s3-wildcard-audit-v1",
            "status": "incomplete",
            "missing": missing,
            "invalid": invalid,
        }
    ...
    manifest = {
        "schema": "s567c8-interleave-ssss-o-s-o-s3-wildcard-manifest-v1",
        ...
        "coverage_proof": {
            ...
            "exact_switches": 8,
            "fixed_switch_slots": [0, 1, 2, 3, 5, 7, 8, 9],
        ...
        "scope_exclusions": [
            "ordinary slots other than 4 and 6",
        ...
        "conclusion": (
            ...
            "pairs for topology SWITCHx4,K1,SWITCH,K2,SWITCHx3. The width-1 shard "
