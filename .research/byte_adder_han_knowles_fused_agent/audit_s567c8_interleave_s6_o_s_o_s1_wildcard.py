"""Audit complete wildcard coverage for SWITCHx6,K1,SWITCH,K2,SWITCH."""
...
BASENAME = "s567c8_g18_o2s8_interleave_s6_o_s_o_s1_cadical195"
EVIDENCE = REMOTE / f"{BASENAME}.json"
LOG = REMOTE / f"{BASENAME}.log"
RUN = REMOTE / f"{BASENAME}.run.json"
DEFAULT_MANIFEST = HERE / "s567c8_interleave_s6_o_s_o_s1_wildcard_manifest.json"
DEFAULT_AUDIT = HERE / "s567c8_interleave_s6_o_s_o_s1_wildcard_audit.json"
...
EXPECTED = {
    "evidence": "5ec01ba249868845942b4c01693195fc4d676a241ae1841e208c37bc046616a8",
    "log": "ea5ee72b19ece3040bc0173f2faa5550e9e94699340c8d3d4a9c03b50338dd76",
    "run": "d9c49c815e4d2028c679266471289018fe65a1f99cfea7e7d6f3b9c8e01ee4f4",
...
def main() -> int:
    ...
    if missing:
        audit = {
            "schema": "s567c8-interleave-s6-o-s-o-s1-wildcard-audit-v1",
            "status": "incomplete",
            "missing": missing,
            "invalid": invalid,
        }
    ...
    manifest = {
        "schema": "s567c8-interleave-s6-o-s-o-s1-wildcard-manifest-v1",
        ...
        "coverage_proof": {
            ...
            "exact_switches": 8,
            "fixed_switch_slots": [0, 1, 2, 3, 4, 5, 7, 9],
        ...
        "scope_exclusions": [
            "ordinary slots other than 6 and 8",
        ...
        "conclusion": (
            ...
            "pairs for topology SWITCHx6,K1,SWITCH,K2,SWITCH. The width-1 shard "
