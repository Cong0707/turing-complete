"""Audit complete wildcard coverage for SWITCHx4,K1,K2,SWITCHx4."""
...
BASENAME = "s567c8_g18_o2s8_interleave_ssss_oo_s4_cadical195"
EVIDENCE = REMOTE / f"{BASENAME}.json"
LOG = REMOTE / f"{BASENAME}.log"
RUN = REMOTE / f"{BASENAME}.run.json"
DEFAULT_MANIFEST = HERE / "s567c8_interleave_ssss_oo_s4_wildcard_manifest.json"
DEFAULT_AUDIT = HERE / "s567c8_interleave_ssss_oo_s4_wildcard_audit.json"
...
EXPECTED = {
    "evidence": "916390da488c9a064052505922e1d89e91c296b5f504eb8d04f8ca48323617cc",
    "log": "37cd75507f795bce75ed6c9c5c9fd5c287e941308b9da572cc7330c2f7bd4009",
    "run": "a2d1522c890d9ee7429a8c6ae5815ae2959abe7b609156060a91e7bdce2ee44b",
...
EXPECTED_PID = 4175542
EXPECTED_WALL_SECONDS = 832.0
...
def main() -> int:
    ...
    if missing:
        audit = {
            "schema": "s567c8-interleave-ssss-oo-s4-wildcard-audit-v1",
            "status": "incomplete",
            "missing": missing,
            "invalid": invalid,
        }
    ...
    manifest = {
        "schema": "s567c8-interleave-ssss-oo-s4-wildcard-manifest-v1",
        ...
        "coverage_proof": {
            ...
            "exact_switches": 8,
            "fixed_switch_slots": [0, 1, 2, 3, 6, 7, 8, 9],
        ...
        "scope_exclusions": [
            "ordinary slots other than 4 and 5",
        ...
        "conclusion": (
            ...
            "pairs for topology SWITCHx4,K1,K2,SWITCHx4. The width-1 shard "
