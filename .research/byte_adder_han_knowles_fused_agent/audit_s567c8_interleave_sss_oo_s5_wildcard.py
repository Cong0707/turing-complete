"""Audit complete wildcard coverage for SWITCHx3,K1,K2,SWITCHx5."""
...
BASENAME = "s567c8_g18_o2s8_interleave_sss_oo_s5_cadical195"
EVIDENCE = REMOTE / f"{BASENAME}.json"
LOG = REMOTE / f"{BASENAME}.log"
RUN = REMOTE / f"{BASENAME}.run.json"
DEFAULT_MANIFEST = HERE / "s567c8_interleave_sss_oo_s5_wildcard_manifest.json"
DEFAULT_AUDIT = HERE / "s567c8_interleave_sss_oo_s5_wildcard_audit.json"
...
EXPECTED = {
    "evidence": "e5c47ef05745b250d01414fe09e95fdefce68e5b607c7831dd5173859574c271",
    "log": "66231f9cbdb6e18dfef8e7189a6715eb20002ed3c226448675ad44ea9ef00c7b",
    "run": "81f1a8022098257f09f91bc909bb633ceacbfa7fb2e300475c2622ef0334e976",
...
def main() -> int:
    ...
    if missing:
        audit = {
            "schema": "s567c8-interleave-sss-oo-s5-wildcard-audit-v1",
            "status": "incomplete",
            "missing": missing,
            "invalid": invalid,
        }
    ...
    run_checks = {
        ...
        "nice": run.get("nice") == 5,
        "wall_seconds": wall_seconds == 824.0,
    ...
    assignment_checks = {
        ...
        "wildcard_slots": all(
            full[3] == pair[0] and full[4] == pair[1]
    ...
    manifest = {
        "schema": "s567c8-interleave-sss-oo-s5-wildcard-manifest-v1",
        ...
        "coverage_proof": {
            ...
            "exact_switches": 8,
            "fixed_switch_slots": [0, 1, 2, 5, 6, 7, 8, 9],
        ...
        "scope_exclusions": [
            "ordinary slots other than 3 and 4",
        ...
        "conclusion": (
            ...
            "pairs for topology SWITCHx3,K1,K2,SWITCHx5. The width-1 shard "
