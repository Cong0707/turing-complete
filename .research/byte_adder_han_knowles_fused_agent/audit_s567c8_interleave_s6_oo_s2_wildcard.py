"""Audit complete wildcard coverage for SWITCHx6,K1,K2,SWITCHx2."""
...
BASENAME = "s567c8_g18_o2s8_interleave_s6_oo_s2_cadical195"
EVIDENCE = REMOTE / f"{BASENAME}.json"
LOG = REMOTE / f"{BASENAME}.log"
RUN = REMOTE / f"{BASENAME}.run.json"
DEFAULT_MANIFEST = HERE / "s567c8_interleave_s6_oo_s2_wildcard_manifest.json"
DEFAULT_AUDIT = HERE / "s567c8_interleave_s6_oo_s2_wildcard_audit.json"
...
EXPECTED = {
    "evidence": "16a6a9cc71cd2597a88bca3fd97e7976632d02d7bcde983a556f2f7600d73994",
    "log": "c51a2039721d574cf0cd30020a1e819d3a2e5e5199b9a737f73f3664a10db444",
    "run": "d300c387b1b24da7e4d2dd75807287f21a59c7c7cc7f720c03c62dbd41fd5172",
...
def main() -> int:
    ...
    if missing:
        audit = {
            "schema": "s567c8-interleave-s6-oo-s2-wildcard-audit-v1",
            "status": "incomplete",
            "missing": missing,
            "invalid": invalid,
        }
    ...
    manifest = {
        "schema": "s567c8-interleave-s6-oo-s2-wildcard-manifest-v1",
        ...
        "coverage_proof": {
            ...
            "exact_switches": 8,
            "fixed_switch_slots": [0, 1, 2, 3, 4, 5, 8, 9],
        ...
        "scope_exclusions": [
            "ordinary slots other than 6 and 7",
        ...
        "conclusion": (
            ...
            "pairs for topology SWITCHx6,K1,K2,SWITCHx2. The width-1 shard "
